...
namespace Swig {
  namespace {
    jclass jclass_ActisenseJavaJNI = NULL;
...
SWIGEXPORT jlong JNICALL Java_de_uniol_inf_is_odysseus_wrapper_actisense_SWIG_ActisenseJavaJNI_new_1ActisenseWrapper(JNIEnv *jenv, jclass jcls, jstring jarg1, jint jarg2) {
  ...
  *(ActisenseWrapper **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_de_uniol_inf_is_odysseus_wrapper_actisense_SWIG_ActisenseJavaJNI_delete_1ActisenseWrapper(JNIEnv *jenv, jclass jcls, jlong jarg1) {
...
SWIGEXPORT void JNICALL Java_de_uniol_inf_is_odysseus_wrapper_actisense_SWIG_ActisenseJavaJNI_ActisenseWrapper_1start(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ActisenseWrapper *arg1 = (ActisenseWrapper *) 0 ;
...
SWIGEXPORT void JNICALL Java_de_uniol_inf_is_odysseus_wrapper_actisense_SWIG_ActisenseJavaJNI_ActisenseWrapper_1stop(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ActisenseWrapper *arg1 = (ActisenseWrapper *) 0 ;
...
SWIGEXPORT void JNICALL Java_de_uniol_inf_is_odysseus_wrapper_actisense_SWIG_ActisenseJavaJNI_swig_1module_1init(JNIEnv *jenv, jclass jcls) {
  int i;
  ...
  if (!Swig::jclass_ActisenseJavaJNI) return;
